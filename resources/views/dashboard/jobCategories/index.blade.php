...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المسمى الوظيفى</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    جدول
                    المسمى الوظيفى</span>
            </div>
        </div>
            ...
            <div class="mb-3 mb-xl-0">
                <div class="btn-group dropdown">
                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-super-scaled"
                        data-toggle="modal" href="#modaldemo8"> <i class="fas fa-plus-circle"></i> أضافة مسمى وظيفى جديد</a>

                    @include('dashboard.JobCategories.create')
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">جدول المسمى الوظيفى</h4>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $info)
                                        ...
                                        <tr>
                                            ...
                                            @include('dashboard.JobCategories.edit')
                                        </tr>
                                        @include('dashboard.JobCategories.delete')
                                    @endforeach
                                </tbody>
                            </table>
                        @else
