     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content modal-content-demo">
             <div class="modal-header">
                 <h6 class="modal-title">أضف مدينة جديدة</h6><button aria-label="Close" class="close" data-dismiss="modal"
                             ...
                             <select name="governorate_id" id="governorate_id" class="form-control">
                                 ...
                                 @if (@isset($other['governorates']) and !@empty($other['governorates']))
                                     @foreach ($other['governorates'] as $governorate)
                                         <option {{ old('governorate_id', $info['governorate_id']) == $governorate->id ? 'selected' : '' }}
